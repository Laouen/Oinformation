...
import org.nd4j.linalg.util.NpyReader;

public class RunOinfoSmoothSoftReLUSystem {
        ...
        try {
            ...
            for (double alpha : alphaValues) {
                ...
                for (int j = 0; j < nRepeat; j++) {
                    ...
                    RandomSystemsGenerator.RandomSystem<String> system = RandomSystemsGenerator.generateSmoothSoftReLUSystem(alpha, beta, powFactorValue, T);
